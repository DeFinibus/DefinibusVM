...
typedef enum {
    ...
    EZVM_JSRI, // Syntax jsr #addr. jump to subroutine at address in program memory
    ...
    EZVM_JZ, // syntax jz #addr. jump to address in program memory if Z flag is set 
    EZVM_JE, // syntax je #addr. jump to address in program memory if E flag is set 
